package com.example.rnschat.gcm;
...
public class DataProvider extends ContentProvider{
    ...
    private static class DbHelper extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_NAME = "rnschat.db";
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.example.rnschat.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.example.rnschat.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("com.example.rnschat.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("com.example.rnschat.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("com.example.rnschat.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("com.example.rnschat.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
